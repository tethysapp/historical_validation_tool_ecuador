...
# from ..app import HistoricalValidationToolEcuador
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_ecuador"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_ecuador.tests.tests"

        To run tests in the HistoricalValidationToolEcuadorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_ecuador.tests.tests.HistoricalValidationToolEcuadorTestCase"

        To run only the test_if_tethys_platform_is_great function in the HistoricalValidationToolEcuadorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_ecuador.tests.tests.HistoricalValidationToolEcuadorTestCase.test_if_tethys_platform_is_great"
